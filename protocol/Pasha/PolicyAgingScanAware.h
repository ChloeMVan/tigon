...
class PolicyAgingScanAware : public MigrationManager {
    public:
        ...
        PolicyAgingScanAware(std::function<migration_result(ITable *, const void *, const std::tuple<std::atomic<uint64_t> *, void *> &, bool, void *&)> move_from_partition_to_shared_region,
