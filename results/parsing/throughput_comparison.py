...
grouped = (
    fig_df.groupby(["cross_ratio", "zipf_theta"], as_index=False)["total_commit"]
    .mean()
)
...
plt.title(f"Figure 1: Throughput vs Cross Ratio (rw_ratio={rw_value}, query_type=rmw)")
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("graphs/thoughput_comparison.png", dpi=300, bbox_inches="tight")